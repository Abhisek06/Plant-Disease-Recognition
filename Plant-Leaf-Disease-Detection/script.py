...
def main():
	filepath = input("Enter Image_1 File Name:\n")
	filepath2 = input("Enter Image_2 File Name:\n")
	filepath3 = input("Enter Image_3 File Name:\n")
	...
	print("result_1:"+analysis(filepath))
#	cv2.waitKey(0)

	print("result_2:"+analysis(filepath2))
#	cv2.waitKey(0)
	print("result_3:"+analysis(filepath3))
	cv2.waitKey(0)
